...
function initializeButton() {
  ...
  let scaryEnterSound = document.getElementsByClassName('.scaryEnterSound');

  enterButton[0].addEventListener('click', myPlay); 
  enterButton[0].addEventListener('mouseenter', myPlay);
...
function initializeGallery() {
  const galleryItems = [
    "assets/images/boolean.jpg",
    "assets/images/meme2.jpg",
    "assets/images/meme3.jpg",
    "assets/images/meme4.jpg",
    "assets/images/meme5.jpg",
    "assets/images/meme6.jpg",
    "assets/images/meme7.jpeg",
    "assets/images/meme8.jpg",
    "assets/images/meme9.png",
    "assets/images/meme10.png",
    "assets/images/meme11.jpeg",
    "assets/images/meme12.png",
    "assets/images/meme13.png",
  ];
